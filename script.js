...
function signUpFunctionality() {
  ...
  let newUser, users, currentUserData;
    ...
    if (
      ...
      fetch("https://api.jsonbin.io/v3/b/66ef3dd2ad19ca34f8aa53da?meta=false", {
        ...
        .then((data) => {
          users = data;
          users.push(newUser);
          // add the user data to the local storage so can access it from login page
...
function loginFunctionality() {
  ...
  // check if there is user data saved in local storage
